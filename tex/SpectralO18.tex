...
\begin{document}
  ...
  \subsection{Two notions of indiscernibility}
    ...
    \begin{definition}[Transported-probe comparison; derivative order of a response]
      ...
      sum of homogeneous ones and inherits their behaviour termwise.
    \end{definition}
    ...
    \begin{proof}
      ...
      non-vanishing first variation distinguishes it from $\chifield$ (the first variation
      vanishes only on stationary configurations).
    \end{proof}
