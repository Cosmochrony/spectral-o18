...
\begin{document}
  ...
  \subsection{Two notions of indiscernibility}
    ...
    \begin{definition}[Transported-probe comparison; derivative order of a response]
      ...
      admissible test directions; the responses of Definition~\ref{def:indiscern} are
      generated by these, with $k = 0$ giving the action-level responses.
    \end{definition}
    ...
    \begin{proof}
      ...
      $-\chifield$ is the opposite-sign configuration, and every response resolving the
      first variation distinguishes it from $\chifield$.
    \end{proof}
    ...
    \begin{remark}[What covariance does and does not give]
      ...
      comparison therefore holds exactly on the even-order part of the response family, and
      fails on the odd-order part.
